...
//  static final String E2D = PGraphicsDanger2D.class.getName();
   ...
   * combination with the trigonometric functions <b>sin()</b> and
   * <b>cos()</b>.
   *
   * ( end auto-generated )
   *
   ...
   * is useful in combination with the trigonometric functions <b>sin()</b> and
   * <b>cos()</b>.
   *
   * ( end auto-generated )
   *
...
//  static public final int STROKED_SHAPE     = 61;
   ...
   * For this reason, be sure to call textMode()
